...
class Day4Test extends FlatSpec with Matchers {
  ...
  it should "mark modify a 0 to 1 if a value has been extracted" in {
    println( Day4.mark(7,Day4.getBoards(input)))
    println(Day4.mark(7,Day4.getBoards(input)).board(0) )
    Day4.mark(7,Day4.getBoards(input)) shouldBe Boards(List((List(List((22,0), (13,0), (17,0), (11,0), (0,0)), List((8,0), (2,0), (23,0), (4,0), (24,0)), List((21,0), (9,0), (14,0), (16,0), (7,1)), List((6,0), (10,0), (3,0), (18,0), (5,0)), List((1,0), (12,0), (20,0), (15,0), (19,0))),0), (List(List((3,0), (15,0), (0,0), (2,0), (22,0)), List((9,0), (18,0), (13,0), (17,0), (5,0)), List((19,0), (8,0), (7,1), (25,0), (23,0)), List((20,0), (11,0), (10,0), (24,0), (4,0)), List((14,0), (21,0), (16,0), (12,0), (6,0))),1), (List(List((14,0), (21,0), (17,0), (24,0), (4,0)), List((10,0), (16,0), (15,0), (9,0), (19,0)), List((18,0), (8,0), (23,0), (26,0), (20,0)), List((22,0), (11,0), (13,0), (6,0), (5,0)), List((2,0), (0,0), (12,0), (3,0), (7,1))),2)))
  ...
  it should "check if at least one line of a board has been marked" in {
    ...
    println(Day4.getWinningBoard(mark1))
  ...
  it should "get winning board" in {
    println(Day4.extractionWinner(Day4.getExtractionNumber(input),Day4.getBoards(input),List.empty))
    Day4.extractionWinner(Day4.getExtractionNumber(input),Day4.getBoards(input),List.empty) shouldBe List(List((14,1), (21,1), (17,1), (24,1), (4,1)), List((10,0), (16,0), (15,0), (9,1), (19,0)), List((18,0), (8,0), (23,1), (26,0), (20,0)), List((22,0), (11,1), (13,0), (6,0), (5,1)), List((2,1), (0,1), (12,0), (3,0), (7,1)))
  }
